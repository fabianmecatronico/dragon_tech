...
function finalizarCompra() {
    ...
    alert(
        "Gracias por tu compra en Dragon Tech. " +
...
function enviarMensaje() {
    ...
    let respuesta =
        "Gracias por escribirnos. Un asesor de Dragon Tech puede ayudarte.";
    ...
    if (
        ...
        respuesta =
            "Tenemos computadores, celulares, audífonos, teclados y otros accesorios.";
